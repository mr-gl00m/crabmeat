export type EffectClass = "read" | "write" | "search" | "exec" | "network" | "privileged";
...
export type ProviderFn = (messages: readonly ProviderMessage[]) => AsyncIterable<ProviderChunk>;
...
export type ReconciliationOutcome = "approved" | "rejected" | "refined" | "exhausted";
