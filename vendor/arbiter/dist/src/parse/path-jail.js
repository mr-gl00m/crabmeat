 ...
 */
export function looksFileLike(s) {
 ...
 */
export function looksLikePathInjection(s) {
...
export function isUnsafeWorkspace(workspace) {
...
function withinWorkspace(absolute, workspace) {
...
export function jailPath(raw, workspace) {
    if (raw.length === 0) {
...
export async function verifyJailedPath(jailedAbsolute, workspace) {
    let realRoot;
    try {
