...
const NEWS_PATTERNS: readonly RegExp[] = [
 ...
 */
const PRONOUN_TOPICS: ReadonlySet<string> = new Set([
  "that",
  "this",
  "it",
  "them",
...
export function parseNewsSearch(text: string): NewsSearchParse | null {
