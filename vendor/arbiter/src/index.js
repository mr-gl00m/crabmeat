...
export function extractIntent(request, opts = {}) {
...
export async function consult(intent, providerFn, opts = {}) {
    return runConsult(intent, providerFn, {
        ...(opts.systemPrompt !== undefined ? { systemPrompt: opts.systemPrompt } : {}),
    });
}
export function reconcile(intent, consultation) {
    return reconcileImpl(intent, consultation);
}
export async function execute(intent, args = {}, runtimeOpts = {}) {
    return runExecute(intent, args, runtimeOpts);
}
export async function handle(request, providerFn, opts = {}) {
